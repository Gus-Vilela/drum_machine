...
function App() {
  const [state,setState] = useState({data: [{id:'Q', src: 'https://s3.amazonaws.com/freecodecamp/drums/Heater-1.mp3', key: 'Q', keyCode: 81, name: 'Heater 1'},
  ...
  {id:'C', src: 'https://s3.amazonaws.com/freecodecamp/drums/Cev_H2.mp3', key: 'C', keyCode: 67, name: 'Closed HH'}], display: ''});
